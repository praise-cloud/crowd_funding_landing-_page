    ...
    <section id="donate" className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14 md:mb-20 reveal" data-reveal>
          <div className="text-sm uppercase tracking-[0.2em] text-rose-500 font-semibold">Donate</div>
          <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mt-3">
            Fund Lifesaving Care Today
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          <div className="card text-center group hover:scale-105 transition-transform duration-300 reveal" data-reveal>
            ...
            <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">PayPal</h3>
          ...
          <div className="card text-center group hover:scale-105 transition-transform duration-300 reveal" data-reveal data-reveal-delay="120">
            ...
            <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">Grey USD</h3>
            <p className="text-gray-600 mb-6">
          ...
          <div className="card text-center group hover:scale-105 transition-transform duration-300 reveal" data-reveal data-reveal-delay="240">
            ...
            <h3 className="font-serif text-2xl font-bold text-gray-900 mb-4">Direct Sponsorship</h3>
            <p className="text-gray-600 mb-6">
        ...
        <div className="mt-12 bg-gradient-to-r from-rose-50 to-orange-50 rounded-3xl p-6 md:p-10 border border-rose-100 reveal" data-reveal>
          <div className="text-center">
            <h3 className="font-serif text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
              Your Impact
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                <div className="text-2xl font-extrabold text-rose-600 mb-1">$50</div>
                <div className="text-sm text-gray-600">Covers essential lab testing</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-extrabold text-green-600 mb-1">$150</div>
                <div className="text-sm text-gray-600">Provides a week of medications</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-extrabold text-orange-600 mb-1">$500</div>
